...
@Component({
  selector: 'app-graphics-people',
  templateUrl: './graphics-people.component.html',
  styleUrls: ['./graphics-people.component.scss']
})
export class GraphicsPeopleComponent {
  private _chart: any;
  ...
  buildPictorialPeople(customdata, nameseriesX, nameseriesY) {
    ...
    am4core.createDeferred(function (div) {
      ...
      let chart = am4core.create("chartdivpeople", am4charts.SlicedChart);
      ...
      series.dataFields.value = nameseriesY;
      series.dataFields.category = nameseriesX;
